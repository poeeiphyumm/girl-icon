@extends('master')
@section('content')
  	<div class="site-blocks-cover" style="background-image: url({{asset('front/images/beauty1.jpg')}});" data-aos="fade" data-stellar-background-ratio="0.5">
        <div class="container">
      ...
      <div class="container">
    		<p class="text-center">Beauty Service</p>
