...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="{{aaset('https://fonts.googleapis.com/css?family=Poppins:200,300,400,700,900|Display+Playfair:200,300,400,700')}}"> 
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-md-6 col-lg-4 text-center mb-5" data-aos="fade-up">
            <img src="{{asset('images/person_1.jpg')}}" alt="Image" class="img-fluid w-50 rounded-circle mb-4">
          ...
          <div class="col-md-6 col-lg-4 text-center mb-5" data-aos="fade-up">
            <img src="{{asset('images/person_2.jpg')}}" alt="Image" class="img-fluid w-50 rounded-circle mb-4">
